  ...
  return (
    <>
      <div className={classes.container}>
        PrivareChat
        {!friendSelected && (
          <div className={classes.friendRequestModal}>
            ...
            <div className={classes.serverInvites}>
        ...
        {friendSelected && (
          <div className="div">
            you are talking to {friendSelected.replace('@gmail.com', '')}
            ...
            {messages.map((message) => (
              <li>
                {" "}
                {message.sentBy.replace('@gmail.com', '')} sent {message.sentTo.replace('@gmail.com', '')} <br /> {message.message}{" "}
              </li>
            ))}
          </div>
        )}
